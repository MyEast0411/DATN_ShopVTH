...
select sum(b.so_luong) as so_luong
            from shopvth.hoa_don a join shopvth.hoa_don_chi_tiet b
            on a.id = b.id_hoa_don
            where a.trang_thai = 7 and a.deleted = 1 and a.ma = "HD12"
            group by a.ma,a.id_khach_hang,a.id_nhan_vien,a.loai_hd,a.trang_thai