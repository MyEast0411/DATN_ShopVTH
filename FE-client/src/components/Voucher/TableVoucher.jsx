...
export default function App({codeVC, setCodeVC, setIsModalVoucher, idKhachHang, tongTien}) {
    ...
    //     return <p>{format(new Date(cellValue), " hh:mm ,   dd-MM-yyyy")}</p>;
      ...
      case "actions":
        return (
            ...
            <Tooltip content="Chọn phiếu giảm giá" showArrow={true}>
              {/*  */}
              <div
                    className="p-2"
                    style={{
    ...
    return (
      <div className="py-2 px-2 flex justify-between items-center">
        <span className="w-[30%] text-small text-default-400">
          Tổng {list.length} phiếu giảm giá
        </span>
        {/* <span className="w-[30%] text-small text-default-400">
        {selectedKeys === "all"
          ? "Đã chọn tất cả"
...
const columns = [
  ...
  { uid: "code", name: "Code" },
  { uid: "ma", name: "Loại phiếu", sortable: true },
