...
export default function ChatLieu() {
  ...
  const confirmDelete = async () => {
    ...
    if (idToDelete) {
      await axios
        .put(`http://localhost:8080/the-loai/deleteTheLoai/${idToDelete}`)
        .then((response) => {
  ...
  const url = "http://localhost:8080/the-loai/getAllTheLoai";
  ...
  const handleOkAddKichCo = async () => {
    ...
    try {
      ...
      await axios
        .post("http://localhost:8080/the-loai/addTheLoai", kichCo)
        .then((response) => {
  ...
  const showModalDetailKichCo = async (value) => {
    ...
    await axios.get(`http://localhost:8080/the-loai/getByMa/${value}`)
      .then((res) => {
  ...
  return (
    <>
      ...
      <div>
        {loading && <TailSpinLoading/>}
        <h2 className="mb-5 font-bold text-2xl">Quản Lý Thể Loại</h2>
        <div>
        ...
        <div className="mb-2 mt-10 justify-between border-b-[2px] font-normal border-gray-500 text-lg	flex items-center">
          <div className="flex items-center">
            ...
            <p className="ml-2 mt-1"> Danh sách thể loại</p>
          </div>
        ...
        >
          <div>
            ...
            >
              ...
              <TableBody
                emptyContent={"Không tìm thấy thể loại nào!"}
                items={sortedItems}
              >
                {(item) => (
