...
export default function ChatLieu() {
  ...
  const confirmDelete = async () => {
    ...
    if (idToDelete) {
      await axios
        .put(`http://localhost:8080/de-giay/deleteDeGiay/${idToDelete}`)
        .then((response) => {
  ...
  const url = "http://localhost:8080/de-giay/getAllDeGiay";
  ...
  const handleOkAddKichCo = async () => {
    ...
    try {
      ...
      await axios
        .post("http://localhost:8080/de-giay/addDeGiay", kichCo)
        .then((response) => {
  ...
  const showModalDetailKichCo = async (value) => {
    ...
    await axios.get(`http://localhost:8080/de-giay/getByMa/${value}`)
      .then((res) => {
  ...
  const handleOkDetailKichCo = async () => {
    ...
    try {
      ...
      await axios
        .put("http://localhost:8080/de-giay/updateDeGiay", {
          id : kichCoDetail.id,
  ...
  return (
    <>
      ...
      <div>
        {loading && <TailSpinLoading/>}
        <h2 className="mb-5 font-bold text-2xl">Quản Lý Đế Giày</h2>
        <div>
        ...
        <div className="mb-2 mt-10 justify-between border-b-[2px] font-normal border-gray-500 text-lg	flex items-center">
          <div className="flex items-center">
            ...
            <p className="ml-2 mt-1"> Danh sách đế giày</p>
          </div>
        ...
        >
          <div>
            ...
            >
              ...
              <TableBody
                emptyContent={"Không tìm thấy đế giày nào!"}
                items={sortedItems}
              >
                {(item) => (
            ...
            >
              ...
              <DialogContent>
                <DialogContentText>
                  Bạn có chắc muốn xóa đế giày này?
                </DialogContentText>
              </DialogContent>
              <DialogActions>
