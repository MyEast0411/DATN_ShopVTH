...
const url = "http://localhost:8080/chat-lieu/getAllChatLieu";
const columns = [
...
export default function ChatLieu() {
  ...
  const handleChange = async (value) => {
    ...
    if (value == -1) {
      ...
      const result = await axios.post(`http://localhost:8080/chat-lieu/filterChatLieu`, {
  ...
  return (
    <>
      ...
      <div>
        {loading && <TailSpinLoading/>}
        <h2 className="mb-5 font-bold text-2xl">Quản Lý Chất Liệu</h2>
        <div>
        ...
        <div className="mb-2 mt-10 justify-between border-b-[2px] font-normal border-gray-500 text-lg	flex items-center">
          <div className="flex items-center">
            ...
            <p className="ml-2 mt-1"> Danh sách chất liệu</p>
          </div>
                    ...
                    rules={[
                      {
                        validator: (rule, value) => {
                          if (!value || value.trim() === '') {
                            return Promise.reject("Mã chất liệu không được để trống!");
                          }
                    ...
                    rules={[
                      {
                        validator: (rule, value) => {
                          if (!value || value.trim() === '') {
                            return Promise.reject("Tên chất liệu không được để trống!");
                          }
                          return Promise.resolve();
                        }
                      }
