...
export default function App({ idVoucher, setDataKhachHang, setModalThemKhachHang }) {
          ...
          <div className="relative flex items-center gap-4">
            <Tooltip content="Chọn khách hàng" showArrow={true}>
              ...
              <div
                    ...
                    onClick={async() => {
                        await axios.put("http://localhost:8080/voucher/addKH_VC", {
                            idVoucher : idVoucher,
                            idKhachHang : sanPham.id
                        })
                        .then((response) => {
